...
<body>
  ...
  <div class="container-xxl bg-dark.bg-dark">
    <header class="d-flex justify-content-left py-3">
      <ul class="nav nav-pills">
        <li class="nav-item"><a href="#" class="nav-link"><font style="color: white;">Home</font></a></li>
  ...
  <div id="carouselExampleCaptions" class="carousel slide " carousel-control-width="50%" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="upiserang.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
        </div>
      </div>
      <div class="carousel-item">
        <img src="upiserang1.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
        </div>
      </div>
      <div class="carousel-item">
        <img src="lab.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
  ...
  <div class="container py-4">
    ...
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        <div class="row">
        <div class="col">
        <h1 class="display-5 fw-bold">UPI Gelar JUMSIH (Jumat Bersih)</h1>
        <p class="col-md-8 fs-4">Universitas Pendidikan Indonesia (UPI) kampus serang mengadakan kegiatan JUMSIH (Jumat Bersih) ..</p>
    ...
    <div class="col-md-6 bg-light">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <strong class="d-inline-block mb-2 text-primary">Universitas</strong>
          <h3 class="mb-0">Pengembangan Program Studi Kelautan</h3>
          <div class="mb-1 text-muted">Juli 12, 2021</div>
          <p class="card-text mb-auto"> Program Studi Kelautan adalah ..</p>
